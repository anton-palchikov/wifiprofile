...
$(window).scroll(function () {
    ...
    if ($('.section__structure--ico').offset().top - scroll <= $(window).height() / 1.2) {
        ...
        var dataset = [{ name: 'FUTURE DEVELOP', count: $('.chart .progressbar:eq(0)').data('value') }, { name: 'ICO ', count: $('.chart .progressbar:eq(1)').data('value') }, { name: 'PRE-ICO', count: $('.chart .progressbar:eq(2)').data('value') }, { name: 'FOUNDERS', count: $('.chart .progressbar:eq(3)').data('value') }, { name: 'TEAM', count: $('.chart .progressbar:eq(4)').data('value') }, { name: 'ADVISER', count: $('.chart .progressbar:eq(5)').data('value') }, { name: 'BOUNTY', count: $('.chart .progressbar:eq(6)').data('value') }];

        var color_array = [$('.chart .progressbar:eq(0)').data('color'), $('.chart .progressbar:eq(1)').data('color'), $('.chart .progressbar:eq(2)').data('color'), $('.chart .progressbar:eq(3)').data('color'), $('.chart .progressbar:eq(4)').data('color'), $('.chart .progressbar:eq(5)').data('color'), $('.chart .progressbar:eq(6)').data('color')];
    ...
    if ($('.section__structure--cost').offset().top - scroll <= $(window).height() / 1.2) {
        ...
        var dataset = [{ name: 'FUTURE DEVELOP', count: $('.chart_1 .progressbar:eq(0)').data('value') }, { name: 'ICO ', count: $('.chart_1 .progressbar:eq(1)').data('value') }, { name: 'PRE-ICO', count: $('.chart_1 .progressbar:eq(2)').data('value') }, { name: 'FOUNDERS', count: $('.chart_1 .progressbar:eq(3)').data('value') }, { name: 'TEAM', count: $('.chart_1 .progressbar:eq(4)').data('value') }, { name: 'ADVISER', count: $('.chart_1 .progressbar:eq(5)').data('value') }, { name: 'BOUNTY', count: $('.chart_1 .progressbar:eq(6)').data('value') }];

        var color_array = [$('.chart_1 .progressbar:eq(0)').data('color'), $('.chart_1 .progressbar:eq(1)').data('color'), $('.chart_1 .progressbar:eq(2)').data('color'), $('.chart_1 .progressbar:eq(3)').data('color'), $('.chart_1 .progressbar:eq(4)').data('color'), $('.chart_1 .progressbar:eq(5)').data('color'), $('.chart_1 .progressbar:eq(6)').data('color')];
